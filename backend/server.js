...
app.get('/debug/formats', async (req, res) => {
  ...
  try {
    const cmd = `yt-dlp --list-formats --extractor-args "youtube:player_client=${client}" --no-check-certificate --verbose --js-runtimes bun:/root/.bun/bin/bun ${cookiesArg} "${url}"`;
