...
function CreativePricing({
  tag = "Planos Viraliza",
  title = "Faça cortes que viralizam",
  description = "Escolha o plano ideal pro seu nível de criação",
  tiers,
}: {
  tag?: string;
  title?: string;
  ...
  // Color palette map (Tailwind purga classes dinâmicas — precisa hardcodar)
              ...
              <div className="mb-6">
                <div
                  className={cn(
                    ...
                    "border-2 border-zinc-900 dark:border-white",
                    colorClasses[tier.color] ?? "text-zinc-900"
                  )}
                >
                  {tier.icon}
                </div>
