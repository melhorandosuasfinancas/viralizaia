...
export function GlowCard({ children, className = "", glowColor = "purple", customSize = false }: GlowCardProps) {
  ...
  return (
    <div
      ref={cardRef}
      data-glow
      className={`rounded-2xl relative backdrop-blur-sm shadow-[0_1rem_2rem_-1rem_black] ${customSize ? "" : "p-4"} ${className}`}
      style={{
        "--base": base,
        "--spread": spread,
        "--radius": "14",
