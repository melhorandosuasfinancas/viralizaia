        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-14">
          ...
          <div className="w-full lg:flex-1 text-center lg:text-left lg:max-w-2xl">
            ...
            <div className="flex justify-center lg:justify-start mt-5">
              <a href="https://play.google.com/store/apps/details?id=com.viralizacortes.viraliza_cortes" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-4 py-2.5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all">
                ...
                <div className="text-left">
                  <div className="text-[10px] text-gray-400 leading-none mb-0.5">Disponível no</div>
